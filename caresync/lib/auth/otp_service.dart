...
class OTPService {
  ...
  // Note: This requires Firebase Cloud Functions to actually send the email
  Future<String> sendOTPEmail(String email) async {
    ...
    // In production, trigger Cloud Function to send email
    // For now, store it and show in console for testing
